...
static TextLayer* s_query_layer, *s_translation_layer;
...
static void window_load(Window* window) {
	...
	//toucan
	s_example_bitmap = gbitmap_create_with_resource(RESOURCE_ID_table);
...
static void window_unload(Window* window) {
	...
	text_layer_destroy(s_translation_layer);
